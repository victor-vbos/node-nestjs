...
export class CreateSalaDto {
  @ApiProperty({ example: 'Event X', description: 'Name of the event' })
  nome: string;

  @ApiProperty({ example: true, description: 'Indicates if the event is active' })
  ativo: boolean;

  @ApiProperty({ example: false, description: 'Indicates if the event is mentorship', required: false, nullable: true })
